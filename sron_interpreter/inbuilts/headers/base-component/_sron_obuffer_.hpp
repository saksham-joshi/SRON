...
inline SronOBuffer& SronOBuffer::operator<< ( const SronString_t& __str)
{
...
inline SronOBuffer& SronOBuffer::operator<< (const SronLstr_t& __str)
{
    this->append(__str.data(), __str.length());
