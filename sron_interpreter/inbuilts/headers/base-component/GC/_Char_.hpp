...
inline SronChar_t Char::getBaseChar() const noexcept
{
    return this->value;
}

inline AnyBindPtr Char::toLowerCase()
{
    return GarbageCollector::registerChar(SronChar::toLowercase(this->value));
}

inline AnyBindPtr Char::toUpperCase()
{
    return GarbageCollector::registerChar(SronChar::toUppercase(this->value));
}

inline bool Char::isLowerCase()
{
    return SronChar::isLowerCase(this->value);
}

inline bool Char::isUpperCase()
{
    return SronChar::isUpperCase(this->value);
}
...
inline AnyPtr Char::__add__(Any &__val , SronTypeNum __type) const
{
    switch ( __type )
    {
        case SronTypeNum::TYPE_INT: return new Char(this->value + intCast( &__val )->getBaseInt());

        case SronTypeNum::TYPE_CHAR: return new Char(this->value + charCast( &__val )->getBaseChar());
...
inline AnyPtr Char::__div__(Any &__val , SronTypeNum __type ) const
{
    switch ( __type )
    {
        case SronTypeNum::TYPE_INT: return new Char(safeDivide((SronInt_t) this->value, intCast( &__val )->getBaseInt()));

        case SronTypeNum::TYPE_CHAR: return new Char(safeDivide((SronInt_t) this->value, (SronInt_t)charCast( &__val )->getBaseChar()));
...
inline AnyPtr Char::__mod__(Any &__val , SronTypeNum __type ) const
{
    switch ( __type )
    {
        case SronTypeNum::TYPE_INT: return new Char(SAFE_MOD((SronInt_t) this->value , (intCast(&__val)->getBaseInt())));

        case SronTypeNum::TYPE_CHAR: return new Char(SAFE_MOD((SronInt_t) this->value , (SronInt_t) (charCast(&__val)->getBaseChar())));
...
inline AnyPtr Char::__pow__(Any &__val , SronTypeNum __type ) const
{
    switch ( __type )
    {
        case SronTypeNum::TYPE_INT: return new Char(std::pow(this->value, intCast(&__val)->getBaseInt()));

        case SronTypeNum::TYPE_CHAR: return new Char(std::pow(this->value, charCast(&__val)->getBaseChar()));
...
inline SronBool_t Char::__isEqual__(Any &__val , SronTypeNum __type ) const
{
    switch ( __type )
    {
        ...
        case SronTypeNum::TYPE_CHAR: return (this->value == charCast(&__val)->getBaseChar());
...
inline void Char::__addAssign__(Any& __val , SronTypeNum __type){
    ...
    switch(__type){
        ...
        case SronTypeNum::TYPE_CHAR : this->value+=(charCast(&__val)->getBaseChar()); break;
...
inline void Char::__powAssign__(Any& __val , SronTypeNum __type){
    ...
    switch(__type){
        ...
        case SronTypeNum::TYPE_CHAR : this->value = std::pow( this->value, (charCast(&__val)->getBaseChar())); break;
