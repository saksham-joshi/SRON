...
{
    return this->push( __ptr , __ptr->typeNum() );
}
...
inline static void GarbageCollector::init()
{
    GarbageCollector::addLayer();

    Void::void_object = GarbageCollector::registerMemory(new Void() , SronTypeNum::TYPE_VOID);
    Bool::__SronTrue = GarbageCollector::registerMemory(new Bool(true) , SronTypeNum::TYPE_BOOL);
    Bool::__SronFalse = GarbageCollector::registerMemory(new Bool(false) , SronTypeNum::TYPE_BOOL);
}

inline static void GarbageCollector::addLayer()
{
...
inline static void GarbageCollector::destroyLayer()
{
...
inline static AnyBindPtr GarbageCollector::registerAt( GarbageCollector::GcSize_t __layer , AnyPtr __value , SronTypeNum __type )
{
    return GarbageCollector::__garbageStack[ __layer ].push( __value , __type );
}

inline static void GarbageCollector::totalDestruction() noexcept
{
    GarbageCollector::__garbageStack.clear();

    GarbageCollector::__top = nullptr;

    GarbageCollector::__gcStackTopLoc = UINT32_MAX;
}
...
inline static AnyBindPtr GarbageCollector::move(AnyBindPtr __binder)
{
    ...
    AnyBindPtr val = GarbageCollector::registerAt( GarbageCollector::__gcStackTopLoc - 1 , __binder->ptr() , __binder->type() );
...
inline static AnyBindPtr GarbageCollector::registerMemory(AnyPtr __ptr)
{
    return GarbageCollector::__top->push(__ptr);
}

inline static AnyBindPtr GarbageCollector::registerMemory(AnyPtr __ptr , SronTypeNum __type )
{
    return GarbageCollector::__top->push( __ptr , __type);
}

inline static AnyBindPtr GarbageCollector::registerInt(const SronInt_t __value)
{
    return GarbageCollector::registerMemory(new Int(__value), SronTypeNum::TYPE_INT);
}

inline static AnyBindPtr GarbageCollector::registerDouble(const SronDouble_t __value)
{
    return GarbageCollector::registerMemory(new Double(__value), SronTypeNum::TYPE_DOUBLE);
}

inline static AnyBindPtr GarbageCollector::registerChar(const SronChar_t __value)
{
    return GarbageCollector::registerMemory(new Char(__value), SronTypeNum::TYPE_CHAR);
}

inline static AnyBindPtr GarbageCollector::registerString(const SronString_t& __value)
{
    return GarbageCollector::registerMemory(new String(__value), SronTypeNum::TYPE_STRING);
}
