...
inline static void SemanticAnalyzer::ANALYZE(TokenVector &__tokenVector)
{
    ...
    using SemanticAnalyzer::iterator;
        ...
        /*
            Calling BytecodeWriter::GENERATE() will give your token vector to
            bytecode writer which generates the bytecode file.

            Now, because the BytecodeWriter is not open-sourced you cannot call it.

            If you want to contribute, then you can only fix issues of Lexical analyzer,
            Semantic analyzer and other components.
        */
