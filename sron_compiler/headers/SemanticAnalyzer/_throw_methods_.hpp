...
inline static void SemanticAnalyzer::THROW_ERROR_IF_NOT_ATTRIBUTE(SronToken &__last_token)
{
    ...
    if (__last_token._type != SronTokenType::TYPE_ATTRIBUTE)
    {
...
inline static void SemanticAnalyzer::THROW_ERROR_IF_INSIDE_MATH_BLOCK(const SronTokenType __type, short __inside_math_expression)
{
    if (__inside_math_expression > 0)
    {
...
inline static void SemanticAnalyzer::THROW_ERROR_IF_DIVISION_BY_ZERO_FOUND(std::string& __str , FilePos_t __file_index)
{
