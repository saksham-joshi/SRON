...
inline static void SemanticAnalyzer::FOUND_TYPE_ATTRIBUTE()
{
    ...
    if(iterator >= SemanticAnalyzer::tokenVectorEnd) throw ThrowException("analyzing the code. Expected some token after '" + iterator->_token + "' but function ended");
    ...
    switch(iterator->_flag){
        ...
        case BytecodeFlags::Flag_Windows :

        case BytecodeFlags::Flag_Linux : SemanticAnalyzer::FOUND_OS_ATTRIBUTE(); break;
...
{
    SemanticAnalyzer::MathBlockAnalyzer analyzer;
