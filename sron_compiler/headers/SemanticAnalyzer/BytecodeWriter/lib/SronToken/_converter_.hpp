...
namespace Converter
{
    ...
    */
    ...
    inline static double TO_DOUBLE(const char *const &__str)
    {
        try
        {
            const char *it = __str;
            ...
            while (*it != '\0')
            {
                ...
                value = (value * 10) + Converter:: get_number_from_char(*it);
            ...
            while (*it != '\0')
            {
                ...
                value += (Converter::get_number_from_char(*it) / temp);
            ...
            return (*__str == '-') ? -value : value;
        }
        catch (const char *)
        {
            throw ThrowException("converting '" + std::string(__str) + "' to double type value", TypeConversionError);
        }
    }
    ...
    */
    ...
    inline static long long int TO_INT(const char *const &__str)
    {
        try
        {
        ...
        catch(const char*)
        {
            ...
            throw ThrowException("converting '" + std::string(__str) + "' to Int type value", TypeConversionError);
        }
    }
    ...
    inline static long long int TO_INT(const std::string &str)
    {
        try
        {
            ...
            for (; it < str.end(); ++it)
            {
                ...
                val = (val*10) + Converter::get_number_from_char(*it);
