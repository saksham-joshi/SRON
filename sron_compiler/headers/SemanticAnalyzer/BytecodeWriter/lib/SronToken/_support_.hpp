    ...
    */
    ...
    inline static BytecodeFlags GET_EQUIVALENT_DATATYPE_EXTRACTOR( BytecodeFlags __flag){
        ...
        switch(__flag){
            ...
            case BytecodeFlags::Flag_FileReader : return BytecodeFlags::Flag_FreadExtractor;

            case BytecodeFlags::Flag_FileWriter : return BytecodeFlags::Flag_FwriteExtractor;

            case BytecodeFlags::Flag_Lstr : return BytecodeFlags::Flag_LstrExtractor;
        ...
        throw ThrowException("extracting the extractor-flag for flag '"+std::string(SronSupport::flagToString(__flag))+"'", SronError::CompilerError);
    }
    ...
    inline static const char* TYPE_TO_STRING(const SronTokenType __type) noexcept{
        ...
        switch(__type){
            ...
            case SronTokenType::NO_TYPE : return "<No-Type>";

            case SronTokenType::TYPE_DEFAULT : return "<Default-type>";
