...
namespace BytecodeManager
{
    ...
    inline static bool isBytecodeCached( AnyBind& __fnc_name )
    {
        ...
        throw ThrowException("finding if the bytecode is cached or not. Expected an argument of type 'String' but found value of type '" + std::string(SronExtra::typenumToString( __fnc_name.type())) + "'" , SronException::ArgumentException);
    }
