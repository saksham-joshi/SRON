...
inline SronInt_t Double::getBaseInt()
{
    return this->value;
}

inline SronDouble_t Double::getBaseDouble()
{
    return this->value;
}

inline SronBool_t Double::getBaseBool()
{
    return this->value;
}

inline DoublePtr Double::getDouble() const
{
    return const_cast<Double *>(this);
}

inline IntPtr Double::getInt() const
{
...
inline BoolPtr Double::getBool() const
{
...
inline AnyPtr Double::__add__(Any & __val , SronTypeNum __type) const
{
    switch ( __type )
    {
        case SronTypeNum::TYPE_INT: return new Double(this->value + **intCast( &__val ));

        case SronTypeNum::TYPE_DOUBLE: return new Double(this->value + **doubleCast( &__val ));

        case SronTypeNum::TYPE_STRING : return new String(std::to_string(this->value).append( **stringCast( &__val) ));
...
inline AnyPtr Double::__div__(Any &__val , SronTypeNum __type) const
{
    switch ( __type )
    {
        case SronTypeNum::TYPE_INT: return new Double(safeDivide(this->value, **intCast( &__val )));

        case SronTypeNum::TYPE_DOUBLE: return new Double(safeDivide(this->value, **doubleCast( &__val )));
...
inline AnyPtr Double::__mod__(Any &__val , SronTypeNum __type) const
{
    ...
    switch ( __type )
    {
        case SronTypeNum::TYPE_INT: return new Double(SAFE_MOD(this->value, **intCast( &__val )));

        case SronTypeNum::TYPE_DOUBLE: return new Double(SAFE_MOD(this->value, **doubleCast( &__val )));
...
inline AnyPtr Double::__pow__(Any &__val , SronTypeNum __type) const
{
    switch ( __type )
    {
        case SronTypeNum::TYPE_INT: return new Double(std::pow(this->value, **intCast( &__val)));

        case SronTypeNum::TYPE_DOUBLE: return new Double(std::pow(this->value, **doubleCast( &__val)));
...
inline SronBool_t Double::__isEqual__(Any &__val , SronTypeNum __type) const
{
    switch ( __type )
    {
        ...
        case SronTypeNum::TYPE_DOUBLE: return this->value == **doubleCast( &__val );
...
inline SronBool_t Double::__lessEqual__(Any &__val , SronTypeNum __type) const
{
    switch ( __type )
    {
        ...
        case SronTypeNum::TYPE_DOUBLE: return (this->value <= **intCast( &__val ));
...
inline void Double::__addAssign__(Any& __val , SronTypeNum __type)
{
    switch(__type)
    {
        ...
        case SronTypeNum::TYPE_DOUBLE : this->value += (**doubleCast( &__val)); break;
...
inline void Double::__modAssign__(Any& __val , SronTypeNum __type){
    ...
    switch(__type)
    {
        case SronTypeNum::TYPE_INT : this->value = std::fmod( this->value, (**intCast( &__val)) ); break;

        case SronTypeNum::TYPE_DOUBLE : this->value = std::fmod(this->value, (**doubleCast( &__val)) ); break;
...
inline void Double::__powAssign__(Any& __val , SronTypeNum __type){
    ...
    switch(__type){
        ...
        case SronTypeNum::TYPE_DOUBLE : this->value = std::pow( this->value, (**doubleCast( &__val)) ); break;
