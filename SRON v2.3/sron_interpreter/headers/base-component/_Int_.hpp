...
inline AnyPtr Int::__add__(Any &__val , SronTypeNum __type) const
{
    switch (__type)
    {
        ...
        case SronTypeNum::TYPE_STRING:
            return new String(this->toString().append(**stringCast( &__val)));
...
inline AnyPtr Int::__div__(Any &__val , SronTypeNum __type) const
{
    ...
    {
        case SronTypeNum::TYPE_INT:
            return new Int(safeDivide(this->value, **intCast( &__val )));

        case SronTypeNum::TYPE_DOUBLE:
            return new Double(safeDivide(this->value, **doubleCast( &__val)));

        case SronTypeNum::TYPE_CHAR:
            return new Int(safeDivide(this->value,(SronInt_t)**charCast( &__val )));
...
inline AnyPtr Int::__xor__(Any &__val , SronTypeNum __type) const
{
    switch(__type){
        ...
        case SronTypeNum::TYPE_INT : return new Int( this->value ^ **intCast( &__val) );

        case SronTypeNum::TYPE_DOUBLE : return new Int( this->value ^ (SronInt_t)**doubleCast( &__val ));

        case SronTypeNum::TYPE_CHAR : return new Int(this->value ^ (SronInt_t)**charCast( &__val ) );
...
inline AnyPtr Int::__bitAnd__(Any &__val , SronTypeNum __type) const
{
    switch(__type){
        ...
        case SronTypeNum::TYPE_CHAR : return new Int(this->value & **charCast( &__val ));
...
inline SronBool_t Int::__isEqual__(Any &__val , SronTypeNum __type) const
{
    switch (__type)
    {
        ...
        case SronTypeNum::TYPE_DOUBLE : return ( this->value == (SronInt_t)**doubleCast( &__val ));

        case SronTypeNum::TYPE_CHAR : return (this->value == (SronInt_t)**charCast( &__val ) );
...
inline SronBool_t Int::__and__(Any &__val , SronTypeNum __type) const
{
    switch (__type)
    {
        ...
        case SronTypeNum::TYPE_BOOL : return ( this->value && (SronInt_t)**boolCast( &__val ));
...
inline void Int::__addAssign__(Any &__val , SronTypeNum __type){
    ...
    switch(__type){
        ...
        case SronTypeNum::TYPE_CHAR : this->value+= ((SronInt_t)**charCast( &__val )); break;
...
inline void Int::__modAssign__(Any &__val , SronTypeNum __type){
    ...
    switch(__type){
        ...
        case SronTypeNum::TYPE_DOUBLE : this->value%= ((SronInt_t)**doubleCast( &__val)); break;
...
inline void Int::__powAssign__(Any &__val , SronTypeNum __type){
    ...
    switch(__type){
        ...
        case SronTypeNum::TYPE_CHAR : this->value = std::pow(this->value, ((SronInt_t) **charCast( &__val ))); break;
