...
namespace Converter
{
    ...
    */
    ...
    inline static SronDouble_t toDouble(const std::string & __str)
    {
    ...
    */
    ...
    inline static std::string toString( SronInt_t __value )
    {
        return std::to_string( __value );
    }
    inline static std::string toString( SronDouble_t __value )
    {
        return std::to_string( __value );
    }
    inline static std::string toString(std::string &__value)
    {
        return __value;
    }
    inline static std::string toString( SronBool_t __value)
    {
        return ( __value ) ? "true" : "false";
    }
    inline static std::string toString( SronChar_t __ch )
    {
    ...
    */
    ...
    inline static SronInt_t toInt(const std::string &__str)
    {
        if( __str.length() == 0 ) return 0;
    ...
    */
    ...
    inline static SronBool_t toBool(std::string &str)
    {
