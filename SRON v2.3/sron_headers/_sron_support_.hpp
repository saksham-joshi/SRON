...
namespace SronSupport
{
    ...
    [[gnu::always_inline]] inline static unsigned long long getExecTime() noexcept // get executime time in milliseconds
    {
        #if defined(_WIN64)
            return clock();
        #elif defined(__linux__)
    ...
    const auto CODE_START_TIME = SronSupport::getExecTime();
