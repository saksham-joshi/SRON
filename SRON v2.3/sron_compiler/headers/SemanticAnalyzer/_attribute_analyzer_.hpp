...
inline static void SemanticAnalyzer::FOUND_LOOP_ATTRIBUTE()
{
    ...
    const BytecodeFlags _attribute_flag = iterator->_flag;
    ...
    if (_attribute_flag == BytecodeFlags::Flag_ForScopeStart)
    {
        if (iterator->_flag == BytecodeFlags::Flag_RangeScopeStart)
        {
    ...
    else if (_attribute_flag == BytecodeFlags::Flag_WhileScopeStart)
    {
        if (iterator->_flag == BytecodeFlags::Flag_Condition)
        {
    ...
    else if(_attribute_flag == BytecodeFlags::Flag_ForeachScopeStart)
    {
        if (iterator->_flag == BytecodeFlags::Flag_ForeachOn){
