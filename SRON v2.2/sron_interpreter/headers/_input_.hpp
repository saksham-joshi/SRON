...
namespace SronInput
{
   ...
   [[gnu::malloc]] [[nodiscard]] inline static StringPtr INPUT_STRING()
    {
        std::cin.sync();
    ...
    [[gnu::malloc]] [[nodiscard]] inline static DoublePtr INPUT_DOUBLE()
    {
        std::cin.sync();
    ...
    // =============================== FOR INT USER INPUTS
    [[gnu::malloc]] [[nodiscard]] inline static IntPtr INPUT_INT()
    {
    ...
    [[gnu::malloc]] [[nodiscard]] inline static CharPtr INPUT_CHAR()
    {
