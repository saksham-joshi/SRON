...
#include "base/_throw_exception_.hpp"
...
namespace Converter
{
    ...
    */
    ...
    inline static SronDouble_t TO_DOUBLE(const std::string & __str)
    {
        ...
        {
            throw ThrowException("converting '"+ __str +"' to Double", SronError::TypeConversionError);
        }
        return 0;
    }
    ...
    */
    ...
    inline static SronInt_t TO_INT(const std::string &__str)
    {
        ...
        {
            throw ThrowException("converting '" + __str + "' to Int", SronError::TypeConversionError);
        }
        return 0;
    }
    ...
    */
    ...
    inline static SronBool_t TO_BOOL(std::string &str)
    {
        ...
        throw ThrowException("converting '" + str + "' to Bool", SronError::TypeConversionError);
